...
class StudentResultSDjpaServiceTest {
    ...
    void findByStudentLastName() {
        when(studentResultRepository.findByStudent_LastName(any())).thenReturn(studentResult);
    ...
    void findByStudentFirstAndLastName() {
        when(studentResultRepository.findByStudent_FirstNameAndStudent_LastName(any(), any())).thenReturn(studentResult);
    ...
    void findByTeacherLastName() {
        when(studentResultRepository.findByTeacher_LastName(any())).thenReturn(studentResult);
    ...
    void findByTeacherFirstAndLastName() {
        when(studentResultRepository.findByTeacher_FirstNameAndTeacher_LastName(any(), any())).thenReturn(studentResult);
    ...
    void findByStudentWorkTitle() {
        when(studentResultRepository.findByStudentWork_Title(any())).thenReturn(studentResult);
    ...
    @Test
    void findByScore() {
        when(studentResultRepository.findByScore(any())).thenReturn(studentResult);
